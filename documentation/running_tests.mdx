...
<Card title="Create Your First Test" icon="sparkles" href="/documentation/your-first-test" cta="Step-by-step guide to creating and running your first test">
  Start with your first test →
</Card>

For full CI/CD integration details:

<Card title="CI/CD Integration" icon="code" href="/documentation/cicd_integration" cta="Integrate tests into your deployment pipeline">
