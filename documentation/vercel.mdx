...
<Frame>
  <img src="/documentation/images/vercel-version-targets.png" alt="Vercel application structure in Autonoma" />
</Frame>
...
<Frame>
  <img src="/documentation/images/vercel-runs-deployment.png" alt="Runs and deployments on Vercel" />
</Frame>
<Frame>
  <img src="/documentation/images/vercel-deployment-checks.png" alt="Deployment checks on Vercel" />
</Frame>
...
<Frame>
  <img src="/documentation/images/bypass-header-zoom.gif" alt="Updating Vercel bypass header in Application Settings" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Create Your First Test" icon="flask-vial" href="/documentation/your-first-test">
    Learn how to create tests for your Vercel project
  </Card>
  
  <Card title="Test Interactions" icon="hand-pointer" href="/documentation/interactions-reference/introduction">
    Check the list of interactions supported by our engine
  </Card>
  
  <Card title="Check Our API" icon="code" href="/documentation/overview">
