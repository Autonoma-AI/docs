...
![Screenshot of integrations settings page](/documentation/images/Screenshot2025-06-04at5.10.18PM.png)

#### Step 2: Select the tests or folders that you want to run in your CI, copy the generated action job!

![Generate action template demonstration](/documentation/images/generate-action-template.gif)
